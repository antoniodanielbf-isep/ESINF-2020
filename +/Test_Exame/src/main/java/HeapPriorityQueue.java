...
public class HeapPriorityQueue<K, V> extends AbstractPriorityQueue<K, V> {
     ...
     */
    protected ArrayList<Priority_queue.Entry<K, V>> heap = new ArrayList<>();
    ...
    protected void swap(int i, int j) {
        Priority_queue.Entry<K, V> temp = heap.get(i);
     ...
     */
    @Override
    public Priority_queue.Entry<K, V> min() {
        try {
     ...
     */
    @Override
    public Priority_queue.Entry<K, V> insert(K key, V value) throws IllegalArgumentException {
     ...
     */
    @Override
    public Priority_queue.Entry<K, V> removeMin() {
        if(heap.size()==0){
            return null;
        }
        Priority_queue.Entry<K,V> entry = heap.remove(0);
        percolateDown(0);
        return entry;
    }
    ...
    public String toString() {
        ...
        if (heap.isEmpty()) {
            ...
            Priority_queue.Entry<K, V> finalEntry = heap.get(heap.size() - 1);
    ...
    public HeapPriorityQueue<K, V> clone() {
        ...
        for(Priority_queue.Entry<K,V> entry:heap){
