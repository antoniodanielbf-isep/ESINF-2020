 ...
 * @author antoniosilva
 */
public class HeapPriorityQueue_1819E<K, V> extends AbstractPriorityQueue<K, V> {
    /**
     ...
     */
    public HeapPriorityQueue_1819E() {
        super();
    }
     ...
     */
    public HeapPriorityQueue_1819E(Comparator<K> comp) {
        super(comp);
    }
     ...
     */
    public HeapPriorityQueue_1819E(K[] keys, V[] values) {
        super();
