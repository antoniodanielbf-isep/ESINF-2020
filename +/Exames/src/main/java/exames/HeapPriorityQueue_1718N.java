...
import utils_heap.AbstractPriorityQueue;
import utils_heap.HeapPriorityQueue;
import utils_tree.Entry;

import java.util.ArrayList;
import java.util.Comparator;

public class HeapPriorityQueue_1718N<K, V> extends AbstractPriorityQueue<K, V> {
    /**
     ...
     */
    public HeapPriorityQueue_1718N() {
        super();
    }
     ...
     */
    public HeapPriorityQueue_1718N(Comparator<K> comp) {
        super(comp);
    }
     ...
     */
    public HeapPriorityQueue_1718N(K[] keys, V[] values) {
        super();
    ...
    @Override
    public HeapPriorityQueue_1819E<K, V> clone() {
        HeapPriorityQueue_1819E<K, V> newHeap = new HeapPriorityQueue_1819E<>(comp);
    ...
    //exercicio 5
    public <K, V extends Comparable<V>> int orderofService(HeapPriorityQueue_1718N<K, V> heap, V value){
        for(int i = 0; i < heap.heap.size(); i++){
            if(value == heap.heap.get(i)) return i + 1;
        }
        return 0;

        /*int j = 0;
       while(!heap.isEmpty()){
           V v = heap.removeMin().getValue();
           if(v == value) return j;
           j++;
       }
         */
