...
public class GraphAlgorithmsTest {
    ...
    public void testBreadthFirstSearch() {
        ...
        assertTrue("Should be null if vertex does not exist", Map_GraphAlgorithms.BreadthFirstSearch(completeMap, "LX") == null);

        LinkedList<String> path = Map_GraphAlgorithms.BreadthFirstSearch(incompleteMap, "Faro");
        ...
        path = Map_GraphAlgorithms.BreadthFirstSearch(incompleteMap, "Porto");
        assertTrue("Should give seven vertices ", path.size() == 7);

        path = Map_GraphAlgorithms.BreadthFirstSearch(incompleteMap, "Viseu");
    ...
    public void testDepthFirstSearch() {
        ...
        assertTrue("Should be null if vertex does not exist", Map_GraphAlgorithms.DepthFirstSearch(completeMap, "LX") == null);

        path = Map_GraphAlgorithms.DepthFirstSearch(incompleteMap, "Faro");
        assertTrue("Should be just one", path.size() == 1);

        Iterator<String> it = path.iterator();
        assertTrue("it should be Faro", it.next().compareTo("Faro") == 0);

        path = Map_GraphAlgorithms.DepthFirstSearch(incompleteMap, "Porto");
        assertTrue("Should give seven vertices ", path.size() == 7);

        path = Map_GraphAlgorithms.DepthFirstSearch(incompleteMap, "Viseu");
        assertTrue("Should give 3 vertices", path.size() == 3);
    ...
    public void testAllPaths() {
        ...
        paths = Map_GraphAlgorithms.allPaths(completeMap, "Porto", "LX");
        assertTrue("There should not be paths if vertex does not exist", paths.isEmpty());

        paths = Map_GraphAlgorithms.allPaths(incompleteMap, "Porto", "Lisboa");
        assertTrue("There should be 4 paths", paths.size() == 4);

        paths = Map_GraphAlgorithms.allPaths(incompleteMap, "Porto", "Faro");
    ...
    public void testShortestPath() {
        ...
        double lenpath;
        lenpath = Map_GraphAlgorithms.shortestPath(completeMap, "Porto", "LX", shortPath);
        assertTrue("Length path should be 0 if vertex does not exist", lenpath == 0);

        lenpath = Map_GraphAlgorithms.shortestPath(incompleteMap, "Porto", "Faro", shortPath);
        assertTrue("Length path should be 0 if there is no path", lenpath == 0);

        lenpath = Map_GraphAlgorithms.shortestPath(completeMap, "Porto", "Porto", shortPath);
        assertTrue("Number of nodes should be 1 if source and vertex are the same", shortPath.size() == 1);

        lenpath = Map_GraphAlgorithms.shortestPath(incompleteMap, "Porto", "Lisboa", shortPath);
        ...
        lenpath = Map_GraphAlgorithms.shortestPath(incompleteMap, "Braga", "Leiria", shortPath);
        ...
        shortPath.clear();
        lenpath = Map_GraphAlgorithms.shortestPath(completeMap, "Porto", "Castelo Branco", shortPath);
    ...
    public void testShortestPaths() {
        ...
        Map_GraphAlgorithms.shortestPaths(completeMap, "Porto", paths, dists);
        ...
        Map_GraphAlgorithms.shortestPaths(incompleteMap, "Porto", paths, dists);
        ...
        Map_GraphAlgorithms.shortestPaths(incompleteMap, "Braga", paths, dists);
